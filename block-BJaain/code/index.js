...
foo(); //Display 'Simple function call' and true
...
person.displayName.call(person2); //undefined
...
// innerItem is not declared because it is created with let keyword
...
let object = {
  ...
  double: function () {
    ...
    return this.data.map(function (item) {
      console.log(this); // points to window because its a callback function
      return item * 2;
    });
  },
...
console.log(getSecondData()); // 2 because of binding of method printsecondData with obj1.So it calls obj1 with its new property from obj2.
